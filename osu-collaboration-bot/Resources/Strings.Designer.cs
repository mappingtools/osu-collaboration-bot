...
namespace CollaborationBot.Resources {
    ...
    public class Strings {
        ...
        ///6. Allow regular members to create collabs: `{0}g [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 1. Create a new project: `{0}project create [PROJECT NAME]` (Choose a simple name which is easy to type and doesn&apos;t contain any spaces)
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0}, you have 48 hours left to complete your part for project `{1}`..
        /// </summary>
        public static string DeadlineReminderCombined {
            get {
                return ResourceManager.GetString("DeadlineReminderCombined", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0}help project
        ///{0}help guild
        ///{0}help part
        ///{0}help asn
        ///{0}help au.
